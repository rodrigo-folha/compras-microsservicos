package br.com.rodrigofolha.pedidos.subscriber;

import br.com.rodrigofolha.pedidos.service.AtualizacaoStatusPedidoService;
import br.com.rodrigofolha.pedidos.subscriber.representation.AtualizacaoStatusPedidoRepresentation;
...
public class AtualizacaoStatusPedidoSubscriber {
    ...
    public void receberAtualizacao(String json) {
        ...
        try {
            AtualizacaoStatusPedidoRepresentation atualizacaoStatus =
